// AutonomousExperimentFunctions.c
//   Functions that can be called for autonomous operation of a virtual robot.
// These functions are for the "FantasticBot" model in RVW.
