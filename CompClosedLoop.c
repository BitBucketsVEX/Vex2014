...
#pragma config(Motor,  port1,           leftElevatorMotor2, tmotorVex393_HBridge, openLoop)
...
#pragma config(Motor,  port10,          rightElevatorMotor2, tmotorVex393_HBridge, openLoop)
